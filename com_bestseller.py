...
for i in range(1, 6):
    ...
    #client = uReq(page)
    p_html = requests.get(
        'https://www.amazon.com/best-sellers-books-Amazon/zgbs/books/ref=zg_bs_pg_{0}?_encoding=UTF8&pg={0}'.format(i)).text
    # client.close()
    ...
    for contain in main:
        ...
        try:
            url = "https://www.amazon.com" + section.a["href"]
            ans_url = url
        except Exception as e:
